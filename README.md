...
An iOS app for importing NYT Cooking recipes by URL, managing your weekly meal plan, and generating a smart shopping list.

## Features

- **Import recipes** from NYT Cooking by pasting a URL or sharing directly from Safari / the NYT Cooking app
...
- **Share Extension** — share any NYT Cooking URL directly into the app from any other app
...
7. Add your NYT Cooking cookie in **Settings** inside the app to enable authenticated recipe imports
